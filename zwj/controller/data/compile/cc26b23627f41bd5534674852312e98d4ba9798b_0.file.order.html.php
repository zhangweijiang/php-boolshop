<?php
/* Smarty version 3.1.30, created on 2017-04-06 16:07:03
  from "D:\wamp\www\zwj\view\html\admin\order.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58e5f7279185c7_74387991',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cc26b23627f41bd5534674852312e98d4ba9798b' => 
    array (
      0 => 'D:\\wamp\\www\\zwj\\view\\html\\admin\\order.html',
      1 => 1491466016,
      2 => 'file',
    ),
  ),
...
function content_58e5f7279185c7_74387991 (Smarty_Internal_Template $_smarty_tpl) {
...
<br><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['o']->value['add_time'],'%Y-%m-%d %H:%M:%S');?>
				...
				<td style="border:1px solid #e8e8e8;"><?php if ($_smarty_tpl->tpl_vars['o']->value['order_status'] == 0) {?><a href="javascript:void(0)" class="cancel_order1" action_id="<?php echo $_smarty_tpl->tpl_vars['o']->value['action_id'];?>
" style="color:#0d6acb;">取消订单</a><?php } elseif ($_smarty_tpl->tpl_vars['o']->value['order_status'] == 1) {?><a href="javascript:void(0)" style="margin-bottom:9px;display:block;color:#0d6acb;" class="fahuo1" action_id="<?php echo $_smarty_tpl->tpl_vars['o']->value['action_id'];?>
" >设置发货</a><a href="/zwj/controller/admin/order_detail.php?order_id=<?php echo $_smarty_tpl->tpl_vars['o']->value['order_id'];?>
" style="color:#0d6acb;">订单详情</a><?php } elseif ($_smarty_tpl->tpl_vars['o']->value['order_status'] == 2) {?><a href="" style="margin-bottom:9px;display:block;color:red;">待收货</a><a href="/zwj/controller/admin/order_detail.php?order_id=<?php echo $_smarty_tpl->tpl_vars['o']->value['order_id'];?>
" style="color:#0d6acb;">订单详情</a><?php } else { ?><span  style="margin-bottom:9px;display:block;">交易完成</span><a href="/zwj/controller/admin/order_detail.php?order_id=<?php echo $_smarty_tpl->tpl_vars['o']->value['order_id'];?>
...
<br><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['o1']->value['add_time'],'%Y-%m-%d %H:%M:%S');?>
				...
				<td style="border:1px solid #e8e8e8;"><a href="javascript:void()" class="cancel_order" action_id="<?php echo $_smarty_tpl->tpl_vars['o1']->value['action_id'];?>
...
<br><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['o2']->value['add_time'],'%Y-%m-%d %H:%M:%S');?>
				...
				<td style="border:1px solid #e8e8e8;"><a href="javascript:void()" style="margin-bottom:9px;display:block;color:#0d6acb;" class="fahuo" action_id="<?php echo $_smarty_tpl->tpl_vars['o2']->value['action_id'];?>
" >设置发货</a><a href="/zwj/controller/admin/order_detail.php?order_id=<?php echo $_smarty_tpl->tpl_vars['o2']->value['order_id'];?>
...
<br><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['o3']->value['add_time'],'%Y-%m-%d %H:%M:%S');?>
				...
				<td style="border:1px solid #e8e8e8;"><a href="" style="margin-bottom:9px;display:block;color:red;">待收货</a><a href="/zwj/controller/admin/order_detail.php?order_id=<?php echo $_smarty_tpl->tpl_vars['o3']->value['order_id'];?>
" style="color:#0d6acb;">订单详情</a></td>
			</tr>
			<?php
}
...
" style="color:#0d6acb;">订单详情</a><br><a href="javascript:void(0);" style="color:#0d6acb;" class="delete_order4" action_id="<?php echo $_smarty_tpl->tpl_vars['o']->value['action_id'];?>
">删除订单</a></td>
			</tr>
			<?php
}
