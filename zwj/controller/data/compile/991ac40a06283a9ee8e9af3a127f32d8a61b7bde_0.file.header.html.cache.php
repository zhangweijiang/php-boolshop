<?php
/* Smarty version 3.1.30, created on 2017-04-21 17:39:29
  from "D:\wamp\www\zwj\view\html\front\header.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58f9d351c9af68_31201528',
  'has_nocache_code' => true,
  'file_dependency' => 
  array (
    '991ac40a06283a9ee8e9af3a127f32d8a61b7bde' => 
    array (
      0 => 'D:\\wamp\\www\\zwj\\view\\html\\front\\header.html',
      1 => 1492767565,
      2 => 'file',
    ),
  ),
...
function content_58f9d351c9af68_31201528 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '1164058f9d351bd7a37_04183568';
?>
<div id="header_serach" >
	...
	<div id="header">
		<ul class="nav header_left">
			...
			<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php if ($_SESSION[\'username\']) {?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>

			<li class="first">Hi,<a href="#" class="session_username"><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_SESSION[\'username\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
</a>
			</li>
			...
			<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php } else { ?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
			...
			<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php }?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
		...
		<ul class="nav header_right">
			...
			<li><i class="fa fa-shopping-cart red"></i><a href="/zwj/controller/front/shopping_cart.php">购物车<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php if ($_smarty_tpl->tpl_vars[\'all_number\']->value && $_SESSION[\'username\']) {?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';
echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'all_number\']->value;?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';
echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php } else { ?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
0<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php }?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
件</a><i class="fa fa-caret-down"></i></li>
	...
	<ul class="dice-menu">
	  ...
	  <li id="icon-cart"><img src="/zwj/view/images/front/index.png" alt="图片不存在">
	  	  <span>购物车<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php if ($_smarty_tpl->tpl_vars[\'all_number\']->value && $_SESSION[\'username\']) {?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';
echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'all_number\']->value;?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';
echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php } else { ?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
0<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php }?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
	...
	<div class="dice-menu-content">
		...
		<div class="gouwuche_content" >
			<ul style="margin-top:11px;">
				<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php
...
?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
				...
				<li style="height:50px;color:#9e9e9e;font-size:14px;"><input type="checkbox" checked="checked" style="float:left;position:relative;top:18px;left:5px;" class="header_checked"><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php if ($_smarty_tpl->tpl_vars[\'gwcv\']->value[\'goods_color_img\']) {?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
<img src="/zwj/<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'goods_color_img\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
" title="<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'goods_name\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
" style="width:50px;height:50px;float:left;display:block;margin-left:7px;"><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php } else { ?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>

					<img src="/zwj/view/images/front/no_picture.gif"  style="width:50px;height:50px;float:left;display:block;margin-left:7px;"><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php }?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>

					<div style="float:left;display:block;width:70px;" >
						<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php if ($_smarty_tpl->tpl_vars[\'gwcv\']->value[\'goods_color_desc\']) {?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
<span style="height:20px;width:70px;margin-top:5px;oveflow:hidden;" title="颜色:<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'goods_color_desc\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
"><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'goods_color_desc\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
</span><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php } else { ?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
<span style="height:20px;width:70px;margin-top:5px;oveflow:hidden;"></span><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php }?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>

						<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php if ($_smarty_tpl->tpl_vars[\'gwcv\']->value[\'attr_name\']) {?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
<span style="height:20px;width:70px;" title="<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'attr_name\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
:<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'attr_value\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
" ><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'attr_value\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
</span><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php }?>/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>

					</div>
					<div style="height:50px;margin-left:11px;float:left;width:-webkit-fit-content;width:-moz-fit-content;text-align:center;"><span style="float:left;width:16px;border:1px solid #e6e6e6;height:16px;margin-top:17px;line-height:16px;border-radius:13px;visibility:hidden;font-weight:bold;" class="gouwuche_show gouwuche_dec">-</span><span style="width:fit-content;width:-webkit-fit-content;width:-moz-fit-content;float:left;height:50px;line-height:50px;padding:0px 4px;" class="gouwuche_num"><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'number\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
</span>
					...
					<div style="width:-webkit-fit-content;width:-moz-fit-content;float:right;margin-right:11px;height:50px;font-family:Arial;width:fit-content;"><span style="display:block;height:13px;width:13px;border:1px solid #e6e6e6;border-radius:7px;line-height:13px;font-size:12px;float:right;visibility:hidden;" class="gouwuche_show gouwuche_close">×</span><span style="width:-webkit-fit-content;width:-moz-fit-content;display:block;height:20px;"><font>&yen;</font><font class="price_row"><?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'shop_price\']*$_smarty_tpl->tpl_vars[\'gwcv\']->value[\'number\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
</font></span></div>
					<input type="hidden" value="<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'gouwuche_id\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
" class="gouwuche_id" name="gouwuche_id[]">
					<input type="hidden" value="<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_smarty_tpl->tpl_vars[\'gwcv\']->value[\'shop_price\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
" class="shop_price1">
				</li>
...
<input type="hidden" value="<?php echo '/*%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/<?php echo $_SESSION[\'username\'];?>
/*/%%SmartyNocache:1164058f9d351bd7a37_04183568%%*/';?>
" class="username13">
